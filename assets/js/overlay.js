...
const builders = {
  ...
  lens: (a) => `radial-gradient(ellipse 160% 220% at 50% -95%, rgba(255,255,255,${(0.65 * a).toFixed(3)}) 0%, rgba(255,255,255,${(0.60 * a).toFixed(3)}) 88%, rgba(255,255,255,${(0.10 * a).toFixed(3)}) 97%, rgba(255,255,255,0) 100%)`,
};
