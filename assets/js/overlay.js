...
const builders = {
  ...
  lens: (a) => `radial-gradient(ellipse 150% 180% at 50% -60%, rgba(255,255,255,${(0.75 * a).toFixed(3)}) 0%, rgba(255,255,255,${(0.70 * a).toFixed(3)}) 95%, rgba(255,255,255,${(0.25 * a).toFixed(3)}) 99%, rgba(255,255,255,0) 100%)`,
};
